...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SENSORREADING']._serialized_end=151
  _globals['_SENSORINFO']._serialized_start=153
  _globals['_SENSORINFO']._serialized_end=260
